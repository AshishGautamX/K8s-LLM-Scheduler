...
def main():
    ...
    print("\n☸️  Step 3: Checking Kubernetes cluster...")
    try:
    ...
    print("=" * 70)
    print("\n⚠️  IMPORTANT: You need to manually start the scheduler in a separate terminal:")
    ...
    input("\n⏸️  Press ENTER when scheduler is running...")
    ...
    try:
        ...
        if scheduled_count == len(test_pods) and running_count == len(test_pods):
            ...
            print("⚠️  PARTIAL SUCCESS - Pods scheduled but not all running yet")
            print("=" * 70)
